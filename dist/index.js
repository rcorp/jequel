  ...
  while (q.length !== 0) {
    ...
    if (typeof parentNode.value === 'object') {
      ...
      for (key in ref) {
        ...
        console.log('parentNode.path', parentNode.path);
        for (transformPath in transforms) {
          transformFunction = transforms[transformPath];
          console.log('transformPath', transformPath, 'node.path', node.path);
